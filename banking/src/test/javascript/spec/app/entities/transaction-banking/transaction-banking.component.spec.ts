...
import { TransactionBankingComponent } from 'app/entities/transaction-banking/transaction-banking.component';
...
describe('Component Tests', () => {
  describe('TransactionBanking Management Component', () => {
    let comp: TransactionBankingComponent;
    let fixture: ComponentFixture<TransactionBankingComponent>;
    let service: TransactionBankingService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [KeymicobankTestModule],
        declarations: [TransactionBankingComponent],
        providers: [
          {
        ...
        .overrideTemplate(TransactionBankingComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(TransactionBankingComponent);
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new TransactionBanking(123)],
            headers,
          })
        )
      );
