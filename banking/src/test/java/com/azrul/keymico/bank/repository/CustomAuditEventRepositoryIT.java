...
import com.azrul.keymico.bank.config.audit.AuditEventConverter;
import com.azrul.keymico.bank.domain.PersistentAuditEvent;
...
import static com.azrul.keymico.bank.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
