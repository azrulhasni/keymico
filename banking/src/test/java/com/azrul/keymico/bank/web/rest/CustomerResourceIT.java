...
import com.azrul.keymico.bank.domain.Customer;
import com.azrul.keymico.bank.repository.CustomerRepository;
import com.azrul.keymico.bank.service.CustomerService;
...
public class CustomerResourceIT {
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].icNumber").value(hasItem(DEFAULT_IC_NUMBER)))
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.icNumber").value(DEFAULT_IC_NUMBER))
